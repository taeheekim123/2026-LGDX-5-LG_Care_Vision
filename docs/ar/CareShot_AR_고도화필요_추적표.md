...
| 다국어 / TTS | 영어 중심 AR step TTS 메타데이터, Web Speech fallback, Google Cloud TTS 직접 합성 endpoint | 구현됨 / 고도화 필요 | 힌디어/지역어 음성 정책, Supabase Storage mp3 캐시, 언어 선택 UI, 비용/캐시 운영 기준 보완 필요 |
